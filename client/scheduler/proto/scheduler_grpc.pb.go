...
const (
	TaskService_AddTask_FullMethodName    = "/scheduler.TaskService/AddTask"
	TaskService_UpdateTask_FullMethodName = "/scheduler.TaskService/UpdateTask"
	TaskService_DeleteTask_FullMethodName = "/scheduler.TaskService/DeleteTask"
	TaskService_ListTasks_FullMethodName  = "/scheduler.TaskService/ListTasks"
)
...
type TaskServiceClient interface {
	...
	ListTasks(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*TasksResponse, error)
}
...
func (c *taskServiceClient) AddTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
...
func (c *taskServiceClient) ListTasks(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*TasksResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type TaskServiceServer interface {
	...
	ListTasks(context.Context, *EmptyRequest) (*TasksResponse, error)
...
func (UnimplementedTaskServiceServer) AddTask(context.Context, *TaskRequest) (*TaskResponse, error) {
...
func (UnimplementedTaskServiceServer) ListTasks(context.Context, *EmptyRequest) (*TasksResponse, error) {
...
func _TaskService_AddTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).AddTask(ctx, req.(*TaskRequest))
	}
...
func _TaskService_ListTasks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).ListTasks(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "scheduler.TaskService",
